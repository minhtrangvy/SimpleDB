...
public class HeapFileReadTest extends SimpleDbTestBase {
    ...
    public void testIteratorBasic() throws Exception {
		...
		System.out.println("just did the assertFalse");
		...
		System.out.println("just did the try catch for exception not open");
		
        it.open();
        int count = 0;
		System.out.println("hasNext is is is " + it.hasNext());

        while (it.hasNext()) {
    		System.out.println("count is " + count);
    		Tuple test = it.next();
    		System.out.println("it.next is " + test);
