...
//                System.out.println("i:" + i + " j:" + j + " = " + columnValue);
...
//    	System.out.println("in matchTuples3");

        if (Debug.isEnabled()) {
            Debug.log("Expected tuples:");
            for (ArrayList<Integer> t : copy) {
                Debug.log("\t" + Utility.listToString(t));
            	System.out.println("copy in matchTuples3 is: " + Utility.listToString(t));
            }
        }
...
//        	System.out.println("RUNNING WHILE LOOP AGAIN ");

            Tuple t = iterator.next();
            
//        	System.out.println("tuple t is " + t.toString());
